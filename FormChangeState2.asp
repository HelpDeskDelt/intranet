...
<%
           ...
           titulo="Cambiando la entidad federativa destino"
           DoTitulo(titulo)
           ...
           response.write("<tr><td class='subtitulo td-r FontMed'>Entidad Destino:</td><td class='td-l FontMed'>"& rsUpdateEntry2("entidad") &"</td></tr>")        
           response.write("<tr><td class='subtitulo td-r FontMed'>Cambiando a:</td><td class='td-l FontMed'>")
           response.write("<select name='fentidad_destino'><option value='"& rsUpdateEntry("id_entidad") &"'>"& rsUpdateEntry("entidad") &"</option></select></td></tr>")

           response.write("<tr><td class='subtitulo td-r FontMed'>Elija la ciudad:</td><td class='td-l FontMed'><select name='fciudad_destino'>")
